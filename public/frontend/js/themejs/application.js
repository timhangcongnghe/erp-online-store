...
$(document).ready(function($) {
    (function(element) {
        ...
        function animatesItems($this, fdelay, i, el) {
            ...
            $this.attr("style", "-webkit-animation:" + effect + " " + duration + "ms;" + "-moz-animation:" + effect + " " + duration + "ms;" + "-o-animation:" + effect + " " + duration + "ms;" + "-moz-animation-delay:" + fdelay + "ms;" + "-webkit-animation-delay:" + fdelay + "ms;" + "-o-animation-delay:" + fdelay + "ms;" + "animation-delay:" + fdelay + "ms;").delay(fdelay).animate({
                opacity: 1,
                filter: 'alpha(opacity = 100)'
            }, {
                delay: 100
...
$(document).ready(function($) {
    ...
    (function(element) {
        ...
        function enableSelectBoxes() {
            $tab_wrap = $('.ltabs-tabs-wrap', $element), $tab_label_select.html($('.ltabs-tab', $element).filter('.tab-sel').children('.ltabs-tab-label').html());
...
$(document).ready(function() {
    "use strict";
    $('#client-say-slider-content').each(function() {
        var slider = $(this),
            data = slider.data();
    ...
    $('#our-team-slider-content').each(function() {
        var slider = $(this),
    ...
    $('#client-logo-slider-content').each(function() {
        var slider = $(this),
            panels = slider.children('div'),
            data = slider.data();
        slider.children(':not(.yt-content-slide)').remove();
