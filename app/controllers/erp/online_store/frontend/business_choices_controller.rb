    ...
    module Frontend
      class BusinessChoicesController < Erp::Frontend::FrontendController
        def index
          ...
          @meta_description = "Một nét mới lạ tại TimHangCongNghe, các sản phẩm được các doanh nghiệp lựa chọn và tin dùng đều được giới thiệu tại trang Lựa Chọn Từ Doanh Nghiệp"
        end
      end
    end
  end
